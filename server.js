...
mongoose
  .connect(
    "mongodb+srv://harshitakumawat55:harshitaK26@cluster0.tlpy1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/userDB"
  )
...
const userSchema = new mongoose.Schema({
  ...
  password: {
    ...
    validate: {
      validator: (v) => {
        return (
          validator.isLength(v, { min: 6, max: 8 }) &&
          /[A-Z]/.test(v) &&
          /[a-z]/.test(v) &&
          /[^A-Za-z0-9]/.test(v)
        );
      ...
      message: (props) =>
        `Password must be 6-8 characters with 1 uppercase, 1 lowercase, and 1 special character!`,
    },
  },
  creationTime: Date,
